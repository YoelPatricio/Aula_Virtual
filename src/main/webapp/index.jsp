<%-- 
    Document   : index
    Created on : 13/12/2017, 12:15:28 PM
    Author     : Yoel
--%>
		...
		<div class="dropdown">
			...
			<ul class="dropdown-menu" role="menu" aria-labelledby="dLabel">
				<li><a href="index.jsp" >Inicio</a></li>
                                <li><a href="allcursos.jsp" >Cursos</a></li>
	...
	<div class="container">
		...
		<div class="row">
			<div class="col-md-10 col-lg-10 col-md-offset-1 col-lg-offset-1 text-center">	
				...
				<h1 class="title">AULA VIRTUAL</h1>
				<h2 class="subtitle">Adquiere conocimientos tecnológicos</h2>
				...
				<p><a href="login.jsp" class="btn btn-default btn-lg">Ingresar</a></p>
