        ...
        <div id="dialog" title="Datos del Docente" style="display: none;">
            ...
            <div class="row">
                ...
                <div class="col-md-6">
                    ...
                    <input type="text" id="txtCelular"  placeholder="Celular" class="form-control" maxlength="9"/>
                </div>
            </div>
            <br>
            <div class="row">
                ...
                <div class="col-md-6">
                    ...
                    <input type="text" id="txtCIP"  placeholder="CIP" class="form-control" maxlength="30"/>
                </div>
            </div>
            <br>
            <div class="row">
